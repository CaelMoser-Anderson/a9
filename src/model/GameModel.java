...
public class GameModel {
    ...
    // TODO 3.2: Add a field to keep track of the Direction associated with the most recent player
    ...
    /**
     * Returns the direction of our Pacmann player
     */
    ...
    /**
     * Updates our playerCommand Direction to newDirection
     */
    public void updatePlayerCommand(Direction newDirection) {
        playerCommand = newDirection;
    }
    ...
    public GameModel(GameMap map, Randomness randomness, boolean withAI) {
        ...
        // Uncomment the following line after completing TODO 3.4
    ...
    // TODO 3.1: Update the model based on PacMann's arrival at vertex `v`. If there is an item
    ...
    /**
     * Handle a victorious end of the game (i.e., when PacMann has eaten all the DOTs and PELLETs).
     * Transition to the VICTORY state and notify "game_result" observers.
     */
