...
public class GameBoard extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        // TODO 2.4: Add code to visualize the items (dots and pellets) on the board. Each item
        ...
        for (MazeVertex v : model.graph().vertices()) {
            ...
            switch (model.itemAt(v)) {
                case PELLET -> {
                    g2.fill(new Ellipse2D.Double(v.loc().i() + 0.15, v.loc().j() + 0.15,
                            0.7, 0.7));
                }
                case DOT -> {
                    g2.fill(new Ellipse2D.Double(v.loc().i() + 0.35, v.loc().j() + 0.35,
                            0.3, 0.3));
                }
                case NONE -> {
                }
    ...
    void paintGraphVertex(MazeVertex v, Graphics2D g2) {
        ...
        if (v.edgeInDirection(Direction.LEFT) != null) {
            ...
            if (i > 0) {
                ...
                g2.draw(new Line2D.Double(tileGrid.length, j + 0.4, tileGrid.length - 0.2,
                        j2 + 0.4));
            }
        }
        if (v.edgeInDirection(Direction.RIGHT) != null) {
            ...
            if (i < tileGrid.length - 1) {
                ...
                g2.draw(new Line2D.Double(tileGrid.length - 0.2, j + 0.6, tileGrid.length,
                        j2 + 0.6));
        ...
        if (v.edgeInDirection(Direction.UP) != null) {
            ...
            if (j > 0) {
                ...
                g2.draw(new Line2D.Double(i + 0.4, tileGrid[0].length, i2 + 0.4,
                        tileGrid[0].length - 0.2));
            }
        }
        if (v.edgeInDirection(Direction.DOWN) != null) {
            ...
            if (j < tileGrid[0].length - 1) {
                ...
                g2.draw(new Line2D.Double(i + 0.6, tileGrid[0].length - 0.2, i2 + 0.6,
                        tileGrid[0].length));
