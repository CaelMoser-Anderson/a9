...
public class GameFrame extends JFrame implements KeyListener {
    ...
    /**
     * Constructs and returns a JCheckBox that allows the user to toggle whether the vertices and
     * edges of the maze graph are visualized in the application.
     */
    ...
    private void showWinMessage() {
        // TODO 5.1B: Create and show a `JOptionPane` that congratulates the user for winning the
    ...
    private void showLoseMessage() {
        // TODO 5.1C: Create and show a `JOptionPane` that tells the user that their game is over and
    ...
    public void keyPressed(KeyEvent e) {
        // TODO 3.4: Complete the definition of this KeyListener method to respond to key pressed by
